class PipelinePage < ActiveRecord::Base
  ...
  attr_accessible :success_pipeline_page, :fail_pipeline_page, :chance_pipeline_page, :success_pipeline_page_id, :fail_pipeline_page_id, :chance_pipeline_page_id
  ...
  def add_fail_page pipeline_page
    ...
    raise "AddingPageToNonCheckoutPageError" unless self.checkout?
    self.update_attributes!(fail_pipeline_page_id: pipeline_page.id)
  end
